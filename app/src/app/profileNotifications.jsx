    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.cardText}>You will receive medication reminders and appointment nudges.</Text>
        </View>

        <View style={styles.card}>
          <Text style={styles.cardTitle}>Weekly wellness summary</Text>
          <Text style={styles.cardText}>A weekly summary will be sent to your email every Sunday.</Text>
        </View>
      </ScrollView>
    </SafeAreaView>
  );
